    ...
    <div className="space-y-8 max-w-2xl">
      ...
      <div className={sectionCls}>
        ...
        <div className="flex gap-2">
          ...
          >
            ...
            {slotsSaved ? "СОХРАНЕНО!" : "СОХРАНИТЬ СЛОТЫ"}
          </button>
        </div>
      </div>
      ...
      <div className={sectionCls}>
        ...
        >
          ...
          {companiesSaved ? "СОХРАНЕНО!" : "СОХРАНИТЬ СПИСОК"}
        </button>
      </div>
      ...
      <div className={sectionCls}>
        ...
        <form onSubmit={handlePasswordSave} className="space-y-3">
          ...
          <button type="submit" className="flex items-center gap-1.5 bg-fire hover:bg-fire/85 text-white px-5 py-2.5 text-xs font-display tracking-wider rounded-sm transition-all">
